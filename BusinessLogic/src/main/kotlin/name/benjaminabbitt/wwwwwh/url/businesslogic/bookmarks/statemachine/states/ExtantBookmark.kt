...
class ExtantBookmark(id: UUID, var bookmarkName: String, var url: String) : Bookmark(id, LoggerFactory.getLogger(ExtantBookmark::class.java)) {
    override fun handle(bookmarkDeleted: BookmarkDeleted): Bookmark {
        return DeletedBookmark(id, this)
    }
