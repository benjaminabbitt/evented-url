...
public final class ProjectorCoordinatorGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<name.benjaminabbitt.evented.core.Evented.EventBook,
      name.benjaminabbitt.evented.core.Evented.Projection> getHandleSyncMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "HandleSync",
      requestType = name.benjaminabbitt.evented.core.Evented.EventBook.class,
      responseType = name.benjaminabbitt.evented.core.Evented.Projection.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<name.benjaminabbitt.evented.core.Evented.EventBook,
      name.benjaminabbitt.evented.core.Evented.Projection> getHandleSyncMethod() {
    io.grpc.MethodDescriptor<name.benjaminabbitt.evented.core.Evented.EventBook, name.benjaminabbitt.evented.core.Evented.Projection> getHandleSyncMethod;
      ...
      synchronized (ProjectorCoordinatorGrpc.class) {
        if ((getHandleSyncMethod = ProjectorCoordinatorGrpc.getHandleSyncMethod) == null) {
          ProjectorCoordinatorGrpc.getHandleSyncMethod = getHandleSyncMethod =
              io.grpc.MethodDescriptor.<name.benjaminabbitt.evented.core.Evented.EventBook, name.benjaminabbitt.evented.core.Evented.Projection>newBuilder()
  ...
  public static abstract class ProjectorCoordinatorImplBase implements io.grpc.BindableService {
    ...
    public void handleSync(name.benjaminabbitt.evented.core.Evented.EventBook request,
        io.grpc.stub.StreamObserver<name.benjaminabbitt.evented.core.Evented.Projection> responseObserver) {
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                name.benjaminabbitt.evented.core.Evented.Projection>(
  ...
  public static final class ProjectorCoordinatorBlockingStub extends io.grpc.stub.AbstractBlockingStub<ProjectorCoordinatorBlockingStub> {
    ...
    /**
     */
    public name.benjaminabbitt.evented.core.Evented.Projection handleSync(name.benjaminabbitt.evented.core.Evented.EventBook request) {
  ...
  public static final class ProjectorCoordinatorFutureStub extends io.grpc.stub.AbstractFutureStub<ProjectorCoordinatorFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<name.benjaminabbitt.evented.core.Evented.Projection> handleSync(
  ...
  private static abstract class ProjectorCoordinatorBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return name.benjaminabbitt.evented.projector.coordinator.ProjectorCoordinatorOuterClass.getDescriptor();
    }
