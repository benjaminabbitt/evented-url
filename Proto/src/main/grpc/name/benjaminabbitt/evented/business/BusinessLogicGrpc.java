...
public final class BusinessLogicGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<name.benjaminabbitt.evented.core.Evented.ContextualCommand,
      name.benjaminabbitt.evented.core.Evented.EventBook> getHandleMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Handle",
      requestType = name.benjaminabbitt.evented.core.Evented.ContextualCommand.class,
      responseType = name.benjaminabbitt.evented.core.Evented.EventBook.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<name.benjaminabbitt.evented.core.Evented.ContextualCommand,
      name.benjaminabbitt.evented.core.Evented.EventBook> getHandleMethod() {
    io.grpc.MethodDescriptor<name.benjaminabbitt.evented.core.Evented.ContextualCommand, name.benjaminabbitt.evented.core.Evented.EventBook> getHandleMethod;
      ...
      synchronized (BusinessLogicGrpc.class) {
        if ((getHandleMethod = BusinessLogicGrpc.getHandleMethod) == null) {
          BusinessLogicGrpc.getHandleMethod = getHandleMethod =
              io.grpc.MethodDescriptor.<name.benjaminabbitt.evented.core.Evented.ContextualCommand, name.benjaminabbitt.evented.core.Evented.EventBook>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Handle"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  name.benjaminabbitt.evented.core.Evented.ContextualCommand.getDefaultInstance()))
  ...
  public static abstract class BusinessLogicImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void handle(name.benjaminabbitt.evented.core.Evented.ContextualCommand request,
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                name.benjaminabbitt.evented.core.Evented.ContextualCommand,
  ...
  public static final class BusinessLogicBlockingStub extends io.grpc.stub.AbstractBlockingStub<BusinessLogicBlockingStub> {
    ...
    /**
     */
    public name.benjaminabbitt.evented.core.Evented.EventBook handle(name.benjaminabbitt.evented.core.Evented.ContextualCommand request) {
  ...
  public static final class BusinessLogicFutureStub extends io.grpc.stub.AbstractFutureStub<BusinessLogicFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<name.benjaminabbitt.evented.core.Evented.EventBook> handle(
        name.benjaminabbitt.evented.core.Evented.ContextualCommand request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HANDLE:
          serviceImpl.handle((name.benjaminabbitt.evented.core.Evented.ContextualCommand) request,
              (io.grpc.stub.StreamObserver<name.benjaminabbitt.evented.core.Evented.EventBook>) responseObserver);
          break;
        default:
  ...
  private static abstract class BusinessLogicBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return name.benjaminabbitt.evented.business.Business.getDescriptor();
    }
