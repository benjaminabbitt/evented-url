...
public final class BookmarkGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Bookmarks.CreateBookmark,
      com.google.protobuf.Empty> getCreateBookmarkMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "createBookmark",
      requestType = Bookmarks.CreateBookmark.class,
      responseType = com.google.protobuf.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Bookmarks.CreateBookmark,
      com.google.protobuf.Empty> getCreateBookmarkMethod() {
    io.grpc.MethodDescriptor<Bookmarks.CreateBookmark, com.google.protobuf.Empty> getCreateBookmarkMethod;
      ...
      synchronized (BookmarkGrpc.class) {
        if ((getCreateBookmarkMethod = BookmarkGrpc.getCreateBookmarkMethod) == null) {
          BookmarkGrpc.getCreateBookmarkMethod = getCreateBookmarkMethod =
              io.grpc.MethodDescriptor.<Bookmarks.CreateBookmark, com.google.protobuf.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "createBookmark"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Bookmarks.CreateBookmark.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<Bookmarks.DeleteBookmark,
      com.google.protobuf.Empty> getDeleteBookmarkMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "deleteBookmark",
      requestType = Bookmarks.DeleteBookmark.class,
      responseType = com.google.protobuf.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Bookmarks.DeleteBookmark,
      com.google.protobuf.Empty> getDeleteBookmarkMethod() {
    io.grpc.MethodDescriptor<Bookmarks.DeleteBookmark, com.google.protobuf.Empty> getDeleteBookmarkMethod;
      ...
      synchronized (BookmarkGrpc.class) {
        if ((getDeleteBookmarkMethod = BookmarkGrpc.getDeleteBookmarkMethod) == null) {
          BookmarkGrpc.getDeleteBookmarkMethod = getDeleteBookmarkMethod =
              io.grpc.MethodDescriptor.<Bookmarks.DeleteBookmark, com.google.protobuf.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "deleteBookmark"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Bookmarks.DeleteBookmark.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.protobuf.Empty.getDefaultInstance()))
  ...
  public static abstract class BookmarkImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void createBookmark(Bookmarks.CreateBookmark request,
    ...
    /**
     */
    public void deleteBookmark(Bookmarks.DeleteBookmark request,
                               io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
  ...
  public static final class BookmarkBlockingStub extends io.grpc.stub.AbstractBlockingStub<BookmarkBlockingStub> {
    ...
    /**
     */
    public com.google.protobuf.Empty createBookmark(Bookmarks.CreateBookmark request) {
    ...
    /**
     */
    public com.google.protobuf.Empty deleteBookmark(Bookmarks.DeleteBookmark request) {
      return blockingUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_BOOKMARK:
          serviceImpl.createBookmark((Bookmarks.CreateBookmark) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        case METHODID_DELETE_BOOKMARK:
          serviceImpl.deleteBookmark((Bookmarks.DeleteBookmark) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        default:
  ...
  private static abstract class BookmarkBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return Bookmarks.getDescriptor();
    }
