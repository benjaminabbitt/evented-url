...
public final class EventQueryGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<QueryOuterClass.Query,
      Evented.EventBook> getGetEventsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetEvents",
      requestType = QueryOuterClass.Query.class,
      responseType = Evented.EventBook.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<QueryOuterClass.Query,
      Evented.EventBook> getGetEventsMethod() {
    io.grpc.MethodDescriptor<QueryOuterClass.Query, Evented.EventBook> getGetEventsMethod;
      ...
      synchronized (EventQueryGrpc.class) {
        if ((getGetEventsMethod = EventQueryGrpc.getGetEventsMethod) == null) {
          EventQueryGrpc.getGetEventsMethod = getGetEventsMethod =
              io.grpc.MethodDescriptor.<QueryOuterClass.Query, Evented.EventBook>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetEvents"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  QueryOuterClass.Query.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<QueryOuterClass.Query,
      Evented.EventBook> getSynchronizeMethod;
  ...
  public static io.grpc.MethodDescriptor<QueryOuterClass.Query,
      Evented.EventBook> getSynchronizeMethod() {
    io.grpc.MethodDescriptor<QueryOuterClass.Query, Evented.EventBook> getSynchronizeMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.protobuf.Empty,
          QueryOuterClass.AggregateRoot> getGetAggregateRootsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAggregateRoots",
      requestType = com.google.protobuf.Empty.class,
      responseType = QueryOuterClass.AggregateRoot.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.google.protobuf.Empty,
          QueryOuterClass.AggregateRoot> getGetAggregateRootsMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Empty, QueryOuterClass.AggregateRoot> getGetAggregateRootsMethod;
      ...
      synchronized (EventQueryGrpc.class) {
        if ((getGetAggregateRootsMethod = EventQueryGrpc.getGetAggregateRootsMethod) == null) {
          EventQueryGrpc.getGetAggregateRootsMethod = getGetAggregateRootsMethod =
              io.grpc.MethodDescriptor.<com.google.protobuf.Empty, QueryOuterClass.AggregateRoot>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  QueryOuterClass.AggregateRoot.getDefaultInstance()))
  ...
  public static abstract class EventQueryImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getEvents(QueryOuterClass.Query request,
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<QueryOuterClass.Query> synchronize(
        io.grpc.stub.StreamObserver<Evented.EventBook> responseObserver) {
    ...
    public void getAggregateRoots(com.google.protobuf.Empty request,
        io.grpc.stub.StreamObserver<QueryOuterClass.AggregateRoot> responseObserver) {
  ...
  public static final class EventQueryBlockingStub extends io.grpc.stub.AbstractBlockingStub<EventQueryBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<Evented.EventBook> getEvents(
    ...
    /**
     */
    public java.util.Iterator<QueryOuterClass.AggregateRoot> getAggregateRoots(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_EVENTS:
          serviceImpl.getEvents((QueryOuterClass.Query) request,
              (io.grpc.stub.StreamObserver<Evented.EventBook>) responseObserver);
          break;
